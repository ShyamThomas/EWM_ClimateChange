...
ACCESS.forecast_2preds_varSecchi_Analog=ACCESS.forecast%>%select(roaddensity_density_mperha, avg.ann.gdd)%>%filter(avg.ann.gdd<2367)
ACCESS.forecast_2preds_varSecchi_Analog=rename(ACCESS.forecast_2preds_varSecchi_Analog,  ACCESS.avg.ann.gdd =avg.ann.gdd)
preds_lst=rep(lst(ACCESS.forecast_2preds_varSecchi_Analog),11)
...
MRI.forecast_2preds_varSecchi_Analog=rename(MRI.forecast_2preds_varSecchi_Analog,  MRI.avg.ann.gdd =avg.ann.gdd)
preds_lst=rep(lst(MRI.forecast_2preds_varSecchi_Analog),11)
...
GFDL.forecast_2preds_varSecchi.Analog=GFDL.forecast%>%select(roaddensity_density_mperha, avg.ann.gdd)%>%filter(avg.ann.gdd<2449)
GFDL.forecast_2preds_varSecchi.Analog= rename(GFDL.forecast_2preds_varSecchi.Analog,  GFDL.avg.ann.gdd =avg.ann.gdd)
preds_lst=rep(lst(GFDL.forecast_2preds_varSecchi.Analog),11)
...
MIROC5.forecast_2preds_varSecchi.Analog= rename(MIROC5.forecast_2preds_varSecchi.Analog,  MIROC5.avg.ann.gdd =avg.ann.gdd)
preds_lst=rep(lst(MIROC5.forecast_2preds_varSecchi.Analog),11)
...
IPSL.forecast_2preds_varSecchi.Analog= rename(IPSL.forecast_2preds_varSecchi.Analog,  IPSL.avg.ann.gdd =avg.ann.gdd)
preds_lst=rep(lst(IPSL.forecast_2preds_varSecchi.Analog),11)
